...
class ActuatorWrapperWithTauMultiAxes(ActuatorWrapper):
    ...
    axes = ['X', 'Y', 'Theta', 'Power', 'Temp', 'Frequency', 'Speed']
    _units = ['µm', 'mm', '°', 'mW', '°C', 'Hz', 'rpm']
    units = _units
    epsilons = [1, 0.0001, 1, 1, 0.1, 0.001, 0.001]  # the precision is therefore 1 µm, 1e-4 mm and 1° and 1 mW and 0.1 degree
    _tau = 0.5  # in s
